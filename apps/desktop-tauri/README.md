...
This package is an experimental Tauri shell for BroCode. It exists to prove that the existing web UI and TypeScript backend can run inside a lighter native desktop host. The Electron desktop app remains supported while the Tauri migration is validated.
