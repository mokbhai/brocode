// This file mostly exists because we want dev mode to say "BroCode (Dev)" instead of "electron"
...
const APP_BUNDLE_ID = isDevelopment ? "com.t3tools.brocode.dev" : "com.t3tools.brocode";
const LAUNCHER_VERSION = 2;
const MICROPHONE_USAGE_DESCRIPTION =
  "BroCode needs microphone access so you can record voice notes and transcribe them into the chat composer.";
