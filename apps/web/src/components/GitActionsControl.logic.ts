...
import { isTemporaryWorktreeBranch, resolveUniqueBroCodeBranchName } from "@t3tools/shared/git";
...
export function resolveDefaultCreateBranchName(
  ...
  return resolveUniqueBroCodeBranchName(existingBranchNames, preferredBranch);
}
