...
export const WHATS_NEW_ENTRIES: readonly WhatsNewEntry[] = [
  {
    ...
    features: [
      {
        id: "cursor-provider",
        title: "Cursor is now a first-class BroCode provider",
        description:
          "Run Cursor CLI sessions directly from BroCode with ACP-backed startup, model discovery, existing-chat resume, handoff, and provider health checks alongside Codex and OpenCode.",
      },
      {
