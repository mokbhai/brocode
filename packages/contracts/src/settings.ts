...
export const ServerSettings = Schema.Struct({
  ...
  enableCodexBrowserTool: Schema.Boolean.pipe(Schema.withDecodingDefault(() => false)),
  preventSystemSleepDuringActiveChats: Schema.Boolean.pipe(Schema.withDecodingDefault(() => true)),
...
export const ServerSettingsPatch = Schema.Struct({
  ...
  enableCodexBrowserTool: Schema.optionalKey(Schema.Boolean),
  preventSystemSleepDuringActiveChats: Schema.optionalKey(Schema.Boolean),
